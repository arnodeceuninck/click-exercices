...
sourceUDP::FastUDPSource(RATE 5, LIMIT 200, LENGTH 60, SRCETH sourceAddr, SRCIP sourceAddr, SPORT 1234, DSTETH responderAddr, DSTIP responderAddr, DPORT 1234);
sourceUDP
    -> Unqueue
	-> [0] sourceRouter [0]
	-> [0] switch
...
responder
    -> Shaper(2) // TODO: Hoe ping voorrang geven??? Terug een CheckUDPHeader, en indien UDP terug in de Shaper steken? Geeft dit geen loop?
	-> [0] responderRouter::Router(responderAddr) [0]
	-> checkUDP::CheckUDPHeader[1]
	-> [1] switch
