...
// src: https://github.com/kohler/click/wiki/ICMPPingSource
source::ICMPPingSource(sourceAddr, responderAddr, LIMIT 20); // optioneel STOP true, dan stopt click ook ineens
